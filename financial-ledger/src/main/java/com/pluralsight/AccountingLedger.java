...
public class AccountingLedger {
    ...
    /**
     * Reads transaction data from the CSV file and adds transactions to the transaction ArrayList.
     * @throws IOException If an I/O error occurs.
     */
    public static void readAndAddToTransactionHistory() throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            //Pass the values that are split as arguments to a method that creates a NEW INSTANCE OF A CLASS
            //Create a new Transaction object from the split values and add it to the transaction history ArrayList
    ...
    /**
     * Creates a Transaction object from an array of string values extracted from a CSV file.
     * @param csvTransactions An array of string values representing transaction data.
    ...
    public static Transaction createTransactionFromCsv(String[] csvTransactions) {
        //Split up values based by the index of the array into variables for better reading
        ...
        //Create a new Transaction object with the extracted data and return the new object
        return new Transaction(transactionDate, transactionTime, transactionDescription, transactionVendor, transactionAmount);
    }

    /**
     * Displays the main menu of the Account Ledger application and handles user interactions.
    ...
    public static void displayHomeScreen(Scanner scanner) throws IOException {
        ...
        switch (choice) {
            ...
            case "X":
                ...
                break;
            default:
                //If user types the wrong option not displayed. Use recursion by calling the method within itself
    ...
    /**
     * Prompts the user to enter details for a new transaction and adds it to the ledger.
     * @param scanner A Scanner object for user input.
     * @param isDeposit A boolean indicating if the transaction is a deposit (true) or payment (false).
     * @throws IOException If an I/O error occurs.
     */
     ...
     * @param displayOption The option to filter transactions (e.g., "All", "Deposits", "Payments").
    ...
    public static void displayTransactions(String displayOption, Scanner scanner) throws IOException {
        ...
        //Iterate through transaction history and filter based on the displayOption variable
    ...
    /**
     * Calculates the total income and expenses from the transaction history ArrayList.
     *
     * @param scanner The scanner object for user input.
     * @throws IOException If an I/O error occurs.
     */
    public static void calculateLedgerBalance(Scanner scanner) throws IOException {
        ...
        for(Transaction transaction : transactionHistory){
            // Check if the transaction amount is greater than 0 (income) or less than 0 (expenses) using the Getter Method
            if(transaction.getAmount() > 0){
                // Accumulate income each time through the loop iteration
                totalIncome += transaction.getAmount();
            } else {
                //Accumulate expenses (amounts are negative) each time through the loop iteration
    ...
    /**
     * Generates and displays a report of transactions from the beginning of the current month to the current date.
     * @param scanner The Scanner object for user input.
     * @throws IOException If an I/O error occurs.
     */
    ...
    /**
     * Generates and displays a report of transactions from the beginning of the year to the current date.
     * @param scanner The Scanner object for user input.
     * @throws IOException If an I/O error occurs.
     */
    ...
    /**
     * Allows the user to perform a custom search based on specified criteria and displays the matching transactions.
     * @param scanner The Scanner object for user input.
     * @throws IOException If an I/O error occurs.
     */
